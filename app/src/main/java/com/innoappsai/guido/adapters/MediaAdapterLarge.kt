...
class MediaAdapterLarge(private val appContext: Context) :
    ...
    inner class VideoViewHolder(private val binding: VideoItemLayoutBinding) :
    ...
    inner class ImageViewHolder(private val binding: LayoutAddImageItemBinding) :
        RecyclerView.ViewHolder(binding.root) {
        fun bind(position: Int, placeMediaItem: PlaceMediaItem) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return when {
            ...
            viewType == MediaType.Image.ordinal -> {
                ImageViewHolder(
                    LayoutAddImageItemBinding.inflate(
                        LayoutInflater.from(parent.context),
                        parent,
                        false
                    )
